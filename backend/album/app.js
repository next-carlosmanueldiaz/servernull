...
function listAlbums() {
  ...
  var paramsListAlbums = { Bucket: bucket, Delimiter: '/', Prefix: 'albums/' };
...
function createAlbum(albumName) {
  ...
  var albumKey = 'albums/' + encodeURIComponent(albumName) + '/';
